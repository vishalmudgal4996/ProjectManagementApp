...
public class RoleType   {
  ...
  /**
   * Role id of the owner (user)
   * @return id
  **/
  @ApiModelProperty(required = true, value = "Role id of the owner (user)")
  @NotNull
  ...
  /**
   * Role name of the owner (user)
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Role name of the owner (user)")
  @NotNull
